...
import (
	_ "douyin/cmd/api/biz/model/api"
...
type DouyinRelationFollowListResponse struct {
	...
	StatusCode *int32  `protobuf:"varint,1,req,name=status_code,json=statusCode" json:"status_code,required" form:"status_code,required" query:"status_code,required"` // 状态码，0-成功，其他值-失败
	StatusMsg  *string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`                        // 返回状态描述
	UserList   []*User `protobuf:"bytes,3,rep,name=user_list,json=userList" json:"user_list,omitempty" form:"user_list" query:"user_list"`                             // 用户信息列表
}
...
type DouyinRelationFollowerListResponse struct {
	...
	StatusCode *int32  `protobuf:"varint,1,req,name=status_code,json=statusCode" json:"status_code,required" form:"status_code,required" query:"status_code,required"` // 状态码，0-成功，其他值-失败
	StatusMsg  *string `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg" json:"status_msg,omitempty" form:"status_msg" query:"status_msg"`                        // 返回状态描述
	UserList   []*User `protobuf:"bytes,3,rep,name=user_list,json=userList" json:"user_list,omitempty" form:"user_list" query:"user_list"`                             // 用户列表
}
...
type FriendUser struct {
	...
	WorkCount       *int64  `protobuf:"varint,10,opt,name=work_count,json=workCount" json:"work_count,omitempty" form:"work_count" query:"work_count"`                             //作品数量
	FavoriteCount   *int64  `protobuf:"varint,11,opt,name=favorite_count,json=favoriteCount" json:"favorite_count,omitempty" form:"favorite_count" query:"favorite_count"`         //点赞数量
	Message         *string `protobuf:"bytes,12,opt,name=message" json:"message,omitempty" form:"message" query:"message"`                                                         // 和该好友的最新聊天消息
	MsgType         *int64  `protobuf:"varint,13,req,name=msgType" json:"msgType,required" form:"msgType,required" query:"msgType,required"`                                       // message消息的类型，0 => 当前请求用户接收的消息， 1 => 当前请求用户发送的消息
}
...
var file_relation_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x6e, 0x22, 0x95, 0x01, 0x0a, 0x26, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x72,
	...
	0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0e, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xe1, 0x02, 0x0a, 0x04,
	...
	0x74, 0x22, 0x9b, 0x03, 0x0a, 0x0a, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x55, 0x73, 0x65, 0x72,
	...
	0x18, 0x0d, 0x20, 0x02, 0x28, 0x03, 0x52, 0x07, 0x6d, 0x73, 0x67, 0x54, 0x79, 0x70, 0x65, 0x32,
	0xce, 0x04, 0x0a, 0x0f, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x82, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x6e, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x8d, 0x01, 0x0a, 0x0a, 0x46, 0x6f, 0x6c,
	...
	0x6c, 0x6f, 0x77, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x95, 0x01, 0x0a, 0x0c, 0x46, 0x6f, 0x6c,
	0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2f, 0x2e, 0x72, 0x65, 0x6c, 0x61,
	...
	0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x30, 0x2e, 0x72, 0x65, 0x6c,
	...
	0x12, 0x8d, 0x01, 0x0a, 0x0a, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12,
	...
	0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e,
	0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	0x5f, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x66, 0x72, 0x69, 0x65, 0x6e, 0x64,
	0x5f, 0x6c, 0x69, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x20,
	...
	0x42, 0x23, 0x5a, 0x21, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2f, 0x63, 0x6d, 0x64, 0x2f, 0x61,
...
var file_relation_proto_depIdxs = []int32{
	6, // 0: relation.douyin_relation_follow_list_response.user_list:type_name -> relation.User
	6, // 1: relation.douyin_relation_follower_list_response.user_list:type_name -> relation.User
	...
	2, // 4: relation.RelationService.FollowList:input_type -> relation.douyin_relation_follow_list_request
	4, // 5: relation.RelationService.FollowerList:input_type -> relation.douyin_relation_follower_list_request
	7, // 6: relation.RelationService.FriendList:input_type -> relation.douyin_relation_friend_list_request
	1, // 7: relation.RelationService.RelationAction:output_type -> relation.douyin_relation_action_response
	3, // 8: relation.RelationService.FollowList:output_type -> relation.douyin_relation_follow_list_response
	5, // 9: relation.RelationService.FollowerList:output_type -> relation.douyin_relation_follower_list_response
	8, // 10: relation.RelationService.FriendList:output_type -> relation.douyin_relation_friend_list_response
