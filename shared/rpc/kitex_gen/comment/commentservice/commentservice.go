...
func (p *kClient) CommentAction(ctx context.Context, request *comment.DouyinCommentActionRequest) (r *comment.DouyinCommentActionResponse, err error) {
...
func (p *kClient) CommentList(ctx context.Context, request *comment.DouyinCommentListRequest) (r *comment.DouyinCommentListResponse, err error) {
