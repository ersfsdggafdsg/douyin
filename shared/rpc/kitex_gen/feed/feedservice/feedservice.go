...
func feedHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	...
	success, err := handler.(feed.FeedService).Feed(ctx, realArg.Request)
	if err != nil {
		return err
	}
...
func (p *kClient) Feed(ctx context.Context, request *feed.DouyinFeedRequest) (r *feed.DouyinFeedResponse, err error) {
