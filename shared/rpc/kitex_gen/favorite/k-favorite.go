...
func (p *FavoriteServiceIsFavoritedArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FavoriteServiceIsFavoritedArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *FavoriteServiceIsFavoritedArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *FavoriteServiceIsFavoritedArgs) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *FavoriteServiceIsFavoritedArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *FavoriteServiceIsFavoritedArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FavoriteServiceIsFavoritedArgs) BLength() int {
	l := 0
...
func (p *FavoriteServiceIsFavoritedArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "user_id", thrift.I64, 1)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.UserId)
...
func (p *FavoriteServiceIsFavoritedArgs) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "video_id", thrift.I64, 2)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.VideoId)
...
func (p *FavoriteServiceIsFavoritedArgs) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("user_id", thrift.I64, 1)
	l += bthrift.Binary.I64Length(p.UserId)
...
func (p *FavoriteServiceIsFavoritedArgs) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("video_id", thrift.I64, 2)
	l += bthrift.Binary.I64Length(p.VideoId)
...
func (p *FavoriteServiceIsFavoritedResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FavoriteServiceIsFavoritedResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *FavoriteServiceIsFavoritedResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *FavoriteServiceIsFavoritedResult) FastWrite(buf []byte) int {
	return 0
}

func (p *FavoriteServiceIsFavoritedResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *FavoriteServiceIsFavoritedResult) BLength() int {
	l := 0
...
func (p *FavoriteServiceIsFavoritedResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *FavoriteServiceIsFavoritedResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *FavoriteServiceIsFavoritedArgs) GetFirstArgument() interface{} {
	return p.UserId
}

func (p *FavoriteServiceIsFavoritedResult) GetResult() interface{} {
	return p.Success
}
